...
return array(
    ...
    */
    ...
    'collections' => array(
        ...
        'application-css' => function($collection)
        {
            /**
             * CSS
             */
            $collection->directory('assets/bower_components', function($collection)
            {
                $collection->stylesheet('bootstrap/dist/css/bootstrap.css');
                $collection->stylesheet('flat-ui-official/css/flat-ui.css');
        ...
        'application-js' => function($collection)
        {
            /**
             * JS
             */
            $collection->directory('assets/bower_components', function($collection)
            {
                ...
                $collection->javascript('flat-ui-official/js/jquery-ui-1.10.3.custom.min.js');
                $collection->javascript('flat-ui-official/js/jquery.ui.touch-punch.min.js');
                
                $collection->javascript('bootstrap/dist/js/bootstrap.js');
                #$collection->javascript('bootstrap/js/button.js');
                #$collection->javascript('bootstrap/js/radio.js');
                #$collection->javascript('bootstrap/js/modal.js');
                #$collection->javascript('bootstrap/js/tooltip.js');
                #$collection->javascript('bootstrap/js/popover.js');
                #$collection->javascript('bootstrap/js/tab.js');
                #$collection->javascript('bootstrap/js/transition.js');
                #$collection->javascript('bootstrap/js/alert.js');

                $collection->javascript('flat-ui-official/js/bootstrap-select.js');
                #$collection->javascript('flat-ui-official/js/bootstrap-switch.js');
                $collection->javascript('flat-ui-official/js/flatui-checkbox.js');
                $collection->javascript('flat-ui-official/js/flatui-radio.js');
                #$collection->javascript('flat-ui-official/js/jquery.tagsinput.js');
                $collection->javascript('flat-ui-official/js/jquery.placeholder.js');
            })->apply('JsMin');
            
            $collection->directory('assets/scripts', function($collection)
            {
                $collection->javascript('commons.js');
